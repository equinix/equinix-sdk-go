...
type VirtualDeviceInternalPatchRequestDto struct {
	...
	TermLengthEffectiveImmediate *bool `json:"termLengthEffectiveImmediate,omitempty"`
	...
	AutoRenewalOptOut    *bool                                             `json:"autoRenewalOptOut,omitempty"`
...
// GetTermLengthEffectiveImmediate returns the TermLengthEffectiveImmediate field value if set, zero value otherwise.
func (o *VirtualDeviceInternalPatchRequestDto) GetTermLengthEffectiveImmediate() bool {
	if o == nil || IsNil(o.TermLengthEffectiveImmediate) {
		var ret bool
		return ret
	}
	return *o.TermLengthEffectiveImmediate
}

// GetTermLengthEffectiveImmediateOk returns a tuple with the TermLengthEffectiveImmediate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualDeviceInternalPatchRequestDto) GetTermLengthEffectiveImmediateOk() (*bool, bool) {
	if o == nil || IsNil(o.TermLengthEffectiveImmediate) {
		return nil, false
	}
	return o.TermLengthEffectiveImmediate, true
}
...
// SetTermLengthEffectiveImmediate gets a reference to the given bool and assigns it to the TermLengthEffectiveImmediate field.
func (o *VirtualDeviceInternalPatchRequestDto) SetTermLengthEffectiveImmediate(v bool) {
	o.TermLengthEffectiveImmediate = &v
}
...
// GetAutoRenewalOptOut returns the AutoRenewalOptOut field value if set, zero value otherwise.
func (o *VirtualDeviceInternalPatchRequestDto) GetAutoRenewalOptOut() bool {
	if o == nil || IsNil(o.AutoRenewalOptOut) {
		var ret bool
		return ret
	}
	return *o.AutoRenewalOptOut
}

// GetAutoRenewalOptOutOk returns a tuple with the AutoRenewalOptOut field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualDeviceInternalPatchRequestDto) GetAutoRenewalOptOutOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoRenewalOptOut) {
		return nil, false
	}
	return o.AutoRenewalOptOut, true
}
...
// SetAutoRenewalOptOut gets a reference to the given bool and assigns it to the AutoRenewalOptOut field.
func (o *VirtualDeviceInternalPatchRequestDto) SetAutoRenewalOptOut(v bool) {
	o.AutoRenewalOptOut = &v
}
...
func (o VirtualDeviceInternalPatchRequestDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TermLengthEffectiveImmediate) {
		toSerialize["termLengthEffectiveImmediate"] = o.TermLengthEffectiveImmediate
	}
	...
	if !IsNil(o.AutoRenewalOptOut) {
		toSerialize["autoRenewalOptOut"] = o.AutoRenewalOptOut
	}
...
func (o *VirtualDeviceInternalPatchRequestDto) UnmarshalJSON(data []byte) (err error) {
	...
	*o = VirtualDeviceInternalPatchRequestDto(varVirtualDeviceInternalPatchRequestDto)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "termLengthEffectiveImmediate")
		delete(additionalProperties, "virtualDeviceName")
		delete(additionalProperties, "clusterName")
		delete(additionalProperties, "status")
		delete(additionalProperties, "autoRenewalOptOut")
