...
// Relevant for Fortinet devices. Choose \&quot;flex\&quot; if you want to enter a token and \&quot;classic\&quot; if you want to upload a license file.
func (r ApiGetAllowedInterfacesUsingGETRequest) LicenseCategory(licenseCategory string) ApiGetAllowedInterfacesUsingGETRequest {
...
func (a *SetupApiService) GetAllowedInterfacesUsingGETExecute(r ApiGetAllowedInterfacesUsingGETRequest) (*AllowedInterfaceResponse, *http.Response, error) {
	...
	if r.licenseCategory != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "licenseCategory", r.licenseCategory, "")
	}
	if r.cluster != nil {
