...
type VirtualDeviceDetailsResponse struct {
	...
	NewTermLength       *string                      `json:"newTermLength,omitempty"`
...
// GetNewTermLength returns the NewTermLength field value if set, zero value otherwise.
func (o *VirtualDeviceDetailsResponse) GetNewTermLength() string {
	if o == nil || IsNil(o.NewTermLength) {
		var ret string
		return ret
	}
	return *o.NewTermLength
}

// GetNewTermLengthOk returns a tuple with the NewTermLength field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VirtualDeviceDetailsResponse) GetNewTermLengthOk() (*string, bool) {
	if o == nil || IsNil(o.NewTermLength) {
		return nil, false
	}
	return o.NewTermLength, true
}
...
// SetNewTermLength gets a reference to the given string and assigns it to the NewTermLength field.
...
func (o VirtualDeviceDetailsResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NewTermLength) {
		toSerialize["newTermLength"] = o.NewTermLength
	}
...
func (o *VirtualDeviceDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = VirtualDeviceDetailsResponse(varVirtualDeviceDetailsResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "newTermLength")
