...
type VirtualDeviceRequest struct {
	...
	// This field is required for Fortinet devices. Select \"flex\" to enter a token and \"classic\" if you want to upload a license file. The actual token or license is not required at the time of device creation for Fortinet devices.
	...
	// Device throughput. This is required for Juniper devices.
	Throughput *int32 `json:"throughput,omitempty"`
	// Throughput unit. This is required for Juniper devices.
