...
`func (o *ServiceProfileRequest) GetEnvironments() []ProviderEnvironment`

GetEnvironments returns the Environments field if non-nil, zero value otherwise.

### GetEnvironmentsOk

`func (o *ServiceProfileRequest) GetEnvironmentsOk() (*[]ProviderEnvironment, bool)`
...
`func (o *ServiceProfileRequest) SetEnvironments(v []ProviderEnvironment)`

SetEnvironments sets Environments field to given value.

### HasEnvironments

`func (o *ServiceProfileRequest) HasEnvironments() bool`
...
`func (o *ServiceProfileRequest) GetLastMileConfig() ServiceProfileLastMileConfig`

GetLastMileConfig returns the LastMileConfig field if non-nil, zero value otherwise.

### GetLastMileConfigOk

`func (o *ServiceProfileRequest) GetLastMileConfigOk() (*ServiceProfileLastMileConfig, bool)`
...
`func (o *ServiceProfileRequest) SetLastMileConfig(v ServiceProfileLastMileConfig)`

SetLastMileConfig sets LastMileConfig field to given value.

### HasLastMileConfig

`func (o *ServiceProfileRequest) HasLastMileConfig() bool`
