...
**OpticalConnect** | Pointer to [**OpticalConnectPrice**](OpticalConnectPrice.md) |  | [optional] 
...
GetOpticalConnect returns the OpticalConnect field if non-nil, zero value otherwise.

### GetOpticalConnectOk

`func (o *Price) GetOpticalConnectOk() (*OpticalConnectPrice, bool)`

GetOpticalConnectOk returns a tuple with the OpticalConnect field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetOpticalConnect sets OpticalConnect field to given value.
