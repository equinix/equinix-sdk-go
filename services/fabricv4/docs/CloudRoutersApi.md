...
[**GetGatewayAttachmentToCloudRouterByUuid**](CloudRoutersApi.md#GetGatewayAttachmentToCloudRouterByUuid) | **Get** /fabric/v4/gateways/{gatewayId}/routers/{routerId} | Get Gateway Attachment details to a Cloud Router
[**ListGatewayAttachmentsToCloudRouter**](CloudRoutersApi.md#ListGatewayAttachmentsToCloudRouter) | **Get** /fabric/v4/gateways/{gatewayId}/routers | List Cloud Routers of a Gateway Attachment.
...
## GetGatewayAttachmentToCloudRouterByUuid

> CloudRouterForGatewayAttachmentResponse GetGatewayAttachmentToCloudRouterByUuid(ctx, gatewayId, routerId).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudRoutersApi.GetGatewayAttachmentToCloudRouterByUuid(context.Background(), gatewayId, routerId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudRoutersApi.GetGatewayAttachmentToCloudRouterByUuid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetGatewayAttachmentToCloudRouterByUuid`: CloudRouterForGatewayAttachmentResponse
	fmt.Fprintf(os.Stdout, "Response from `CloudRoutersApi.GetGatewayAttachmentToCloudRouterByUuid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetGatewayAttachmentToCloudRouterByUuidRequest struct via the builder pattern
...
## ListGatewayAttachmentsToCloudRouter

> CloudRouterListForGatewayAttachment ListGatewayAttachmentsToCloudRouter(ctx, gatewayId).Offset(offset).Limit(limit).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudRoutersApi.ListGatewayAttachmentsToCloudRouter(context.Background(), gatewayId).Offset(offset).Limit(limit).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudRoutersApi.ListGatewayAttachmentsToCloudRouter``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ListGatewayAttachmentsToCloudRouter`: CloudRouterListForGatewayAttachment
	fmt.Fprintf(os.Stdout, "Response from `CloudRoutersApi.ListGatewayAttachmentsToCloudRouter`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListGatewayAttachmentsToCloudRouterRequest struct via the builder pattern
