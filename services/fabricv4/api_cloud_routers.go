...
type ApiGetGatewayAttachmentToCloudRouterByUuidRequest struct {
	ctx        context.Context
	ApiService *CloudRoutersApiService
	gatewayId  string
	routerId   string
...
func (r ApiGetGatewayAttachmentToCloudRouterByUuidRequest) Execute() (*CloudRouterForGatewayAttachmentResponse, *http.Response, error) {
	return r.ApiService.GetGatewayAttachmentToCloudRouterByUuidExecute(r)
}

/*
GetGatewayAttachmentToCloudRouterByUuid Get Gateway Attachment details to a Cloud Router
...
Get details of a Specific Gateway Attachment to a Cloud Router.
	...
	@param routerId Cloud Router UUID
	@return ApiGetGatewayAttachmentToCloudRouterByUuidRequest
*/
func (a *CloudRoutersApiService) GetGatewayAttachmentToCloudRouterByUuid(ctx context.Context, gatewayId string, routerId string) ApiGetGatewayAttachmentToCloudRouterByUuidRequest {
	return ApiGetGatewayAttachmentToCloudRouterByUuidRequest{
		ApiService: a,
		ctx:        ctx,
		gatewayId:  gatewayId,
...
func (a *CloudRoutersApiService) GetGatewayAttachmentToCloudRouterByUuidExecute(r ApiGetGatewayAttachmentToCloudRouterByUuidRequest) (*CloudRouterForGatewayAttachmentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CloudRouterForGatewayAttachmentResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudRoutersApiService.GetGatewayAttachmentToCloudRouterByUuid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/gateways/{gatewayId}/routers/{routerId}"
...
type ApiListGatewayAttachmentsToCloudRouterRequest struct {
	ctx        context.Context
	ApiService *CloudRoutersApiService
	gatewayId  string
	offset     *int32
...
// offset
func (r ApiListGatewayAttachmentsToCloudRouterRequest) Offset(offset int32) ApiListGatewayAttachmentsToCloudRouterRequest {
	r.offset = &offset
	return r
}

// number of records to fetch
func (r ApiListGatewayAttachmentsToCloudRouterRequest) Limit(limit int32) ApiListGatewayAttachmentsToCloudRouterRequest {
	r.limit = &limit
	return r
}

func (r ApiListGatewayAttachmentsToCloudRouterRequest) Execute() (*CloudRouterListForGatewayAttachment, *http.Response, error) {
	return r.ApiService.ListGatewayAttachmentsToCloudRouterExecute(r)
}

/*
ListGatewayAttachmentsToCloudRouter List Cloud Routers of a Gateway Attachment.

Get all Cloud Routers attached on a Gateway.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param gatewayId Gateway UUID
	@return ApiListGatewayAttachmentsToCloudRouterRequest
*/
func (a *CloudRoutersApiService) ListGatewayAttachmentsToCloudRouter(ctx context.Context, gatewayId string) ApiListGatewayAttachmentsToCloudRouterRequest {
	return ApiListGatewayAttachmentsToCloudRouterRequest{
		ApiService: a,
		ctx:        ctx,
		gatewayId:  gatewayId,
...
func (a *CloudRoutersApiService) ListGatewayAttachmentsToCloudRouterExecute(r ApiListGatewayAttachmentsToCloudRouterRequest) (*CloudRouterListForGatewayAttachment, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CloudRouterListForGatewayAttachment
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CloudRoutersApiService.ListGatewayAttachmentsToCloudRouter")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/gateways/{gatewayId}/routers"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", url.PathEscape(parameterValueToString(r.gatewayId, "gatewayId")), -1)
