...
type SubscriptionAsset struct {
	Type                 *SubscriptionAssetType         `json:"type,omitempty"`
...
// SetType gets a reference to the given SubscriptionAssetType and assigns it to the Type field.
