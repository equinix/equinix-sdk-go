...
// checks if the AuthenticationKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticationKey{}
...
type _AuthenticationKey AuthenticationKey
...
func (o *AuthenticationKey) UnmarshalJSON(data []byte) (err error) {
	varAuthenticationKey := _AuthenticationKey{}

	err = json.Unmarshal(data, &varAuthenticationKey)

	if err != nil {
		return err
	}

	*o = AuthenticationKey(varAuthenticationKey)
