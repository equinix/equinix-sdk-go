...
type ApiSearchRouteFilterRulesRequest struct {
	ctx                           context.Context
	ApiService                    *RouteFilterRulesApiService
	routeFilterId                 string
	routeFilterRulesSearchRequest *RouteFilterRulesSearchRequest
}

func (r ApiSearchRouteFilterRulesRequest) RouteFilterRulesSearchRequest(routeFilterRulesSearchRequest RouteFilterRulesSearchRequest) ApiSearchRouteFilterRulesRequest {
	r.routeFilterRulesSearchRequest = &routeFilterRulesSearchRequest
	return r
}

func (r ApiSearchRouteFilterRulesRequest) Execute() (*RouteFilterRulesSearchResponse, *http.Response, error) {
	return r.ApiService.SearchRouteFilterRulesExecute(r)
}

/*
SearchRouteFilterRules Search Route Filter Rules

This API provides capability to search Route Filter Rules

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param routeFilterId Route Filters Id
	@return ApiSearchRouteFilterRulesRequest
*/
func (a *RouteFilterRulesApiService) SearchRouteFilterRules(ctx context.Context, routeFilterId string) ApiSearchRouteFilterRulesRequest {
	return ApiSearchRouteFilterRulesRequest{
		ApiService:    a,
		ctx:           ctx,
		routeFilterId: routeFilterId,
...
// Execute executes the request
//
//	@return RouteFilterRulesSearchResponse
func (a *RouteFilterRulesApiService) SearchRouteFilterRulesExecute(r ApiSearchRouteFilterRulesRequest) (*RouteFilterRulesSearchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RouteFilterRulesSearchResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RouteFilterRulesApiService.SearchRouteFilterRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/routeFilters/{routeFilterId}/routeFilterRules/search"
	localVarPath = strings.Replace(localVarPath, "{"+"routeFilterId"+"}", url.PathEscape(parameterValueToString(r.routeFilterId, "routeFilterId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.routeFilterRulesSearchRequest == nil {
		return localVarReturnValue, nil, reportError("routeFilterRulesSearchRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.routeFilterRulesSearchRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
