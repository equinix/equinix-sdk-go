...
type ApiGetTagByUuidRequest struct {
	ctx        context.Context
	ApiService *TagsApiService
	uuid       string
}

func (r ApiGetTagByUuidRequest) Execute() (*TagResponse, *http.Response, error) {
	return r.ApiService.GetTagByUuidExecute(r)
}

/*
GetTagByUuid Get Tag

Get Tag by UUID

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param uuid UUID of the Tag
	@return ApiGetTagByUuidRequest
*/
func (a *TagsApiService) GetTagByUuid(ctx context.Context, uuid string) ApiGetTagByUuidRequest {
	return ApiGetTagByUuidRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
//
//	@return TagResponse
func (a *TagsApiService) GetTagByUuidExecute(r ApiGetTagByUuidRequest) (*TagResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagsApiService.GetTagByUuid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/tags/{uuid}"
