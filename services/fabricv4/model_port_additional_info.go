...
// checks if the PortAdditionalInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PortAdditionalInfo{}
...
type _PortAdditionalInfo PortAdditionalInfo
...
func (o *PortAdditionalInfo) UnmarshalJSON(data []byte) (err error) {
	varPortAdditionalInfo := _PortAdditionalInfo{}

	err = json.Unmarshal(data, &varPortAdditionalInfo)

	if err != nil {
		return err
	}

	*o = PortAdditionalInfo(varPortAdditionalInfo)
...
type NullablePortAdditionalInfo struct {
	value *PortAdditionalInfo
	isSet bool
}

func (v NullablePortAdditionalInfo) Get() *PortAdditionalInfo {
	return v.value
}

func (v *NullablePortAdditionalInfo) Set(val *PortAdditionalInfo) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePortAdditionalInfo(val *PortAdditionalInfo) *NullablePortAdditionalInfo {
	return &NullablePortAdditionalInfo{value: val, isSet: true}
}
