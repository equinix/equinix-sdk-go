...
type ApiSearchRouteAggregationRulesRequest struct {
	ctx                                context.Context
	ApiService                         *RouteAggregationRulesApiService
	routeAggregationId                 string
	routeAggregationRulesSearchRequest *RouteAggregationRulesSearchRequest
}

func (r ApiSearchRouteAggregationRulesRequest) RouteAggregationRulesSearchRequest(routeAggregationRulesSearchRequest RouteAggregationRulesSearchRequest) ApiSearchRouteAggregationRulesRequest {
	r.routeAggregationRulesSearchRequest = &routeAggregationRulesSearchRequest
	return r
}

func (r ApiSearchRouteAggregationRulesRequest) Execute() (*RouteAggregationRulesSearchResponse, *http.Response, error) {
	return r.ApiService.SearchRouteAggregationRulesExecute(r)
}

/*
SearchRouteAggregationRules Search Route Aggregation Rules

This API provides capability to search Route Aggregation Rules

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param routeAggregationId Route Aggregations Id
	@return ApiSearchRouteAggregationRulesRequest
*/
func (a *RouteAggregationRulesApiService) SearchRouteAggregationRules(ctx context.Context, routeAggregationId string) ApiSearchRouteAggregationRulesRequest {
	return ApiSearchRouteAggregationRulesRequest{
		ApiService:         a,
		ctx:                ctx,
		routeAggregationId: routeAggregationId,
...
func (a *RouteAggregationRulesApiService) SearchRouteAggregationRulesExecute(r ApiSearchRouteAggregationRulesRequest) (*RouteAggregationRulesSearchResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RouteAggregationRulesSearchResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RouteAggregationRulesApiService.SearchRouteAggregationRules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/routeAggregations/{routeAggregationId}/routeAggregationRules/search"
	localVarPath = strings.Replace(localVarPath, "{"+"routeAggregationId"+"}", url.PathEscape(parameterValueToString(r.routeAggregationId, "routeAggregationId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.routeAggregationRulesSearchRequest == nil {
		return localVarReturnValue, nil, reportError("routeAggregationRulesSearchRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.routeAggregationRulesSearchRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
