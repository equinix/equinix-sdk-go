...
// checks if the AppDomainAttachedAppLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppDomainAttachedAppLink{}

// AppDomainAttachedAppLink App Link object
type AppDomainAttachedAppLink struct {
	// Resource URI
...
type _AppDomainAttachedAppLink AppDomainAttachedAppLink
...
func (o AppDomainAttachedAppLink) MarshalJSON() ([]byte, error) {
...
func (o AppDomainAttachedAppLink) ToMap() (map[string]interface{}, error) {
...
func (o *AppDomainAttachedAppLink) UnmarshalJSON(data []byte) (err error) {
	...
	varAppDomainAttachedAppLink := _AppDomainAttachedAppLink{}

	err = json.Unmarshal(data, &varAppDomainAttachedAppLink)

	if err != nil {
		return err
	}

	*o = AppDomainAttachedAppLink(varAppDomainAttachedAppLink)
...
type NullableAppDomainAttachedAppLink struct {
	value *AppDomainAttachedAppLink
	isSet bool
}

func (v NullableAppDomainAttachedAppLink) Get() *AppDomainAttachedAppLink {
	return v.value
}

func (v *NullableAppDomainAttachedAppLink) Set(val *AppDomainAttachedAppLink) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDomainAttachedAppLink) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDomainAttachedAppLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDomainAttachedAppLink(val *AppDomainAttachedAppLink) *NullableAppDomainAttachedAppLink {
	return &NullableAppDomainAttachedAppLink{value: val, isSet: true}
}

func (v NullableAppDomainAttachedAppLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDomainAttachedAppLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
