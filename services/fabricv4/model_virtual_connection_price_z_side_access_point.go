...
// checks if the VirtualConnectionPriceZSideAccessPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualConnectionPriceZSideAccessPoint{}
...
type _VirtualConnectionPriceZSideAccessPoint VirtualConnectionPriceZSideAccessPoint
...
func (o *VirtualConnectionPriceZSideAccessPoint) UnmarshalJSON(data []byte) (err error) {
	varVirtualConnectionPriceZSideAccessPoint := _VirtualConnectionPriceZSideAccessPoint{}

	err = json.Unmarshal(data, &varVirtualConnectionPriceZSideAccessPoint)

	if err != nil {
		return err
	}

	*o = VirtualConnectionPriceZSideAccessPoint(varVirtualConnectionPriceZSideAccessPoint)
