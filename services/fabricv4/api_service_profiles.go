...
type ApiGetServiceProfileEnvironmentsByUuidRequest struct {
	ctx              context.Context
	ApiService       *ServiceProfilesApiService
	serviceProfileId string
	offset           *int32
...
// offset
func (r ApiGetServiceProfileEnvironmentsByUuidRequest) Offset(offset int32) ApiGetServiceProfileEnvironmentsByUuidRequest {
	r.offset = &offset
	return r
}

// number of records to fetch
func (r ApiGetServiceProfileEnvironmentsByUuidRequest) Limit(limit int32) ApiGetServiceProfileEnvironmentsByUuidRequest {
	r.limit = &limit
	return r
}

func (r ApiGetServiceProfileEnvironmentsByUuidRequest) Execute() (*ProviderEnvironments, *http.Response, error) {
	return r.ApiService.GetServiceProfileEnvironmentsByUuidExecute(r)
}

/*
GetServiceProfileEnvironmentsByUuid Get Profile Environments

Get service profile provider environments by UUID <sup color='red'>Beta</sup></font>.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serviceProfileId Service Profile UUID
	@return ApiGetServiceProfileEnvironmentsByUuidRequest
*/
func (a *ServiceProfilesApiService) GetServiceProfileEnvironmentsByUuid(ctx context.Context, serviceProfileId string) ApiGetServiceProfileEnvironmentsByUuidRequest {
	return ApiGetServiceProfileEnvironmentsByUuidRequest{
		ApiService:       a,
		ctx:              ctx,
		serviceProfileId: serviceProfileId,
...
func (a *ServiceProfilesApiService) GetServiceProfileEnvironmentsByUuidExecute(r ApiGetServiceProfileEnvironmentsByUuidRequest) (*ProviderEnvironments, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ProviderEnvironments
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceProfilesApiService.GetServiceProfileEnvironmentsByUuid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/serviceProfiles/{serviceProfileId}/environments"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceProfileId"+"}", url.PathEscape(parameterValueToString(r.serviceProfileId, "serviceProfileId")), -1)
...
type ApiServiceProfileEnvironmentActionRequest struct {
	ctx                      context.Context
	ApiService               *ServiceProfilesApiService
	serviceProfileId         string
	environmentId            string
	environmentActionRequest *EnvironmentActionRequest
}

func (r ApiServiceProfileEnvironmentActionRequest) EnvironmentActionRequest(environmentActionRequest EnvironmentActionRequest) ApiServiceProfileEnvironmentActionRequest {
	r.environmentActionRequest = &environmentActionRequest
	return r
}

func (r ApiServiceProfileEnvironmentActionRequest) Execute() (*EnvironmentActionResponse, *http.Response, error) {
	return r.ApiService.ServiceProfileEnvironmentActionExecute(r)
}

/*
ServiceProfileEnvironmentAction Service Profile Environment Actions
...
This API provides capability to perform actions on a service profile environment, such as validating an activation key.<sup color='red'>Beta</sup></font>
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param serviceProfileId Service Profile UUID
	@param environmentId Provider Environment Reference
	@return ApiServiceProfileEnvironmentActionRequest
*/
func (a *ServiceProfilesApiService) ServiceProfileEnvironmentAction(ctx context.Context, serviceProfileId string, environmentId string) ApiServiceProfileEnvironmentActionRequest {
	return ApiServiceProfileEnvironmentActionRequest{
		ApiService:       a,
		ctx:              ctx,
		serviceProfileId: serviceProfileId,
...
func (a *ServiceProfilesApiService) ServiceProfileEnvironmentActionExecute(r ApiServiceProfileEnvironmentActionRequest) (*EnvironmentActionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *EnvironmentActionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceProfilesApiService.ServiceProfileEnvironmentAction")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fabric/v4/serviceProfiles/{serviceProfileId}/environments/{environmentId}/actions"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceProfileId"+"}", url.PathEscape(parameterValueToString(r.serviceProfileId, "serviceProfileId")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.environmentActionRequest == nil {
		return localVarReturnValue, nil, reportError("environmentActionRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.environmentActionRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiUpdateServiceProfileByUuidRequest struct {
	...
	ApiService                    *ServiceProfilesApiService
	serviceProfileId              string
	serviceProfileUpdateOperation *[]ServiceProfileUpdateOperation
}

func (r ApiUpdateServiceProfileByUuidRequest) ServiceProfileUpdateOperation(serviceProfileUpdateOperation []ServiceProfileUpdateOperation) ApiUpdateServiceProfileByUuidRequest {
	r.serviceProfileUpdateOperation = &serviceProfileUpdateOperation
	return r
}
...
func (a *ServiceProfilesApiService) UpdateServiceProfileByUuidExecute(r ApiUpdateServiceProfileByUuidRequest) (*ServiceProfile, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.serviceProfileUpdateOperation == nil {
		return localVarReturnValue, nil, reportError("serviceProfileUpdateOperation is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.serviceProfileUpdateOperation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
