...
type SubscriptionResponse struct {
	...
	Marketplace          *SubscriptionResponseMarketplace  `json:"marketplace,omitempty"`
	...
	Entitlements         []SubscriptionEntitlementResponse `json:"entitlements,omitempty"`
...
// SetMarketplace gets a reference to the given SubscriptionResponseMarketplace and assigns it to the Marketplace field.
...
// SetEntitlements gets a reference to the given []SubscriptionEntitlementResponse and assigns it to the Entitlements field.
