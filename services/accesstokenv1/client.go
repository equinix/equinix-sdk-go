...
// APIClient manages communication with the Equinix API Authentication API v1.2
...
type APIClient struct {
	...
	OAuth2TokenApi *OAuth2TokenApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.OAuth2TokenApi = (*OAuth2TokenApiService)(&c.common)
