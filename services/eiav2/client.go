...
// Helper method for parsing API Errors
func formatAdditionalInfo(additionalInfo []ErrorAdditionalInfo) string {
	var str []string
...
func formatErrorMessage(status string, v interface{}) string {
	...
	if ok {
		...
		for _, e := range *errorModelList {
			...
			if additionalInfo := formatAdditionalInfo(e.GetAdditionalInfo()); additionalInfo != "" {
