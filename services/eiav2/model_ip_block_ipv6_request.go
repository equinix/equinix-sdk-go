...
// checks if the IpBlockIpv6Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpBlockIpv6Request{}
...
type _IpBlockIpv6Request IpBlockIpv6Request
...
func (o *IpBlockIpv6Request) UnmarshalJSON(data []byte) (err error) {
	...
	varIpBlockIpv6Request := _IpBlockIpv6Request{}

	err = json.Unmarshal(data, &varIpBlockIpv6Request)

	if err != nil {
		return err
	}

	*o = IpBlockIpv6Request(varIpBlockIpv6Request)
...
func NewNullableIpBlockIpv6Request(val *IpBlockIpv6Request) *NullableIpBlockIpv6Request {
	return &NullableIpBlockIpv6Request{value: val, isSet: true}
}
