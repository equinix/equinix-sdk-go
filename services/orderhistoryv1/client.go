...
// APIClient manages communication with the Retrieve Orders API API v1.0.0
...
type APIClient struct {
	...
	RetrieveOrdersApi *RetrieveOrdersApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.RetrieveOrdersApi = (*RetrieveOrdersApiService)(&c.common)
