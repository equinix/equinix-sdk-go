...
// checks if the EnvironmentDataStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentDataStatus{}

// EnvironmentDataStatus struct for EnvironmentDataStatus
...
type _EnvironmentDataStatus EnvironmentDataStatus
...
func (o EnvironmentDataStatus) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentDataStatus) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentDataStatus) UnmarshalJSON(data []byte) (err error) {
	varEnvironmentDataStatus := _EnvironmentDataStatus{}

	err = json.Unmarshal(data, &varEnvironmentDataStatus)

	if err != nil {
		return err
	}

	*o = EnvironmentDataStatus(varEnvironmentDataStatus)
...
type NullableEnvironmentDataStatus struct {
	value *EnvironmentDataStatus
	isSet bool
}

func (v NullableEnvironmentDataStatus) Get() *EnvironmentDataStatus {
	return v.value
}

func (v *NullableEnvironmentDataStatus) Set(val *EnvironmentDataStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentDataStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentDataStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentDataStatus(val *EnvironmentDataStatus) *NullableEnvironmentDataStatus {
	return &NullableEnvironmentDataStatus{value: val, isSet: true}
}

func (v NullableEnvironmentDataStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentDataStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
