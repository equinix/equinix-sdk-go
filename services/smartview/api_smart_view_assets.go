...
// Specify the OAuth Bearer token with prefix &#39;Bearer &#39;.
func (r ApiMixin3Request) Authorization(authorization string) ApiMixin3Request {
	r.authorization = &authorization
	return r
}

// request schema
func (r ApiMixin3Request) Payload(payload AssetDetailsRequest) ApiMixin3Request {
	r.payload = &payload
	return r
}

func (r ApiMixin3Request) Execute() (*AssetDetailsResponse, *http.Response, error) {
	return r.ApiService.Mixin3Execute(r)
}

/*
Mixin3 get asset details
...
This endpoint returns information about assets details including the assets tag points list for the given multiple asset identifiers.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMixin3Request
*/
func (a *SmartViewAssetsApiService) Mixin3(ctx context.Context) ApiMixin3Request {
	return ApiMixin3Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SmartViewAssetsApiService) Mixin3Execute(r ApiMixin3Request) (*AssetDetailsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmartViewAssetsApiService.Mixin3")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiMixin3_0Request struct {
	ctx context.Context
	ApiService *SmartViewAssetsApiService
	authorization *string
...
// Specify the OAuth Bearer token with prefix &#39;Bearer &#39;.
func (r ApiMixin3_0Request) Authorization(authorization string) ApiMixin3_0Request {
	r.authorization = &authorization
	return r
}

func (r ApiMixin3_0Request) Payload(payload CurrentTagPointRequest) ApiMixin3_0Request {
	r.payload = &payload
	return r
}

func (r ApiMixin3_0Request) Execute() (*TagPointData, *http.Response, error) {
	return r.ApiService.Mixin3_1Execute(r)
}

/*
Mixin3_0 get current tag points data

This endpoint fetches the latest read values for given tag points using given tag identifiers.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiMixin3_0Request
*/
func (a *SmartViewAssetsApiService) Mixin3_1(ctx context.Context) ApiMixin3_0Request {
	return ApiMixin3_0Request{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TagPointData
func (a *SmartViewAssetsApiService) Mixin3_1Execute(r ApiMixin3_0Request) (*TagPointData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmartViewAssetsApiService.Mixin3_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
