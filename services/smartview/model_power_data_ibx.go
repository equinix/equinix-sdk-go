...
// checks if the PowerDataIBX type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PowerDataIBX{}

// PowerDataIBX struct for PowerDataIBX
...
type _PowerDataIBX PowerDataIBX
...
func (o PowerDataIBX) MarshalJSON() ([]byte, error) {
...
func (o PowerDataIBX) ToMap() (map[string]interface{}, error) {
...
func (o *PowerDataIBX) UnmarshalJSON(data []byte) (err error) {
	varPowerDataIBX := _PowerDataIBX{}

	err = json.Unmarshal(data, &varPowerDataIBX)

	if err != nil {
		return err
	}

	*o = PowerDataIBX(varPowerDataIBX)
...
type NullablePowerDataIBX struct {
	value *PowerDataIBX
	isSet bool
}

func (v NullablePowerDataIBX) Get() *PowerDataIBX {
	return v.value
}

func (v *NullablePowerDataIBX) Set(val *PowerDataIBX) {
	v.value = val
	v.isSet = true
}

func (v NullablePowerDataIBX) IsSet() bool {
	return v.isSet
}

func (v *NullablePowerDataIBX) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePowerDataIBX(val *PowerDataIBX) *NullablePowerDataIBX {
	return &NullablePowerDataIBX{value: val, isSet: true}
}

func (v NullablePowerDataIBX) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePowerDataIBX) UnmarshalJSON(src []byte) error {
	v.isSet = true
