...
// checks if the AssetsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetsStatus{}

// AssetsStatus struct for AssetsStatus
...
type _AssetsStatus AssetsStatus
...
func (o AssetsStatus) MarshalJSON() ([]byte, error) {
...
func (o AssetsStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AssetsStatus) UnmarshalJSON(data []byte) (err error) {
	varAssetsStatus := _AssetsStatus{}

	err = json.Unmarshal(data, &varAssetsStatus)

	if err != nil {
		return err
	}

	*o = AssetsStatus(varAssetsStatus)
...
type NullableAssetsStatus struct {
	value *AssetsStatus
	isSet bool
}

func (v NullableAssetsStatus) Get() *AssetsStatus {
	return v.value
}

func (v *NullableAssetsStatus) Set(val *AssetsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetsStatus(val *AssetsStatus) *NullableAssetsStatus {
	return &NullableAssetsStatus{value: val, isSet: true}
}

func (v NullableAssetsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
