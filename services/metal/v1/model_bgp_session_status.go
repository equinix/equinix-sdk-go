...
// List of BgpSession_status
const (
	BGPSESSIONSTATUS_UNKNOWN BgpSessionStatus = "unknown"
	BGPSESSIONSTATUS_UP      BgpSessionStatus = "up"
	BGPSESSIONSTATUS_DOWN    BgpSessionStatus = "down"
)
...
// Ptr returns reference to BgpSession_status value
