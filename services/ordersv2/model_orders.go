...
// Orders An order could be request, service or ticket to performs specified activity on an colo businesss
type Orders struct {
...
func (o *Orders) UnmarshalJSON(data []byte) (err error) {
	varOrders := _Orders{}

	err = json.Unmarshal(data, &varOrders)
