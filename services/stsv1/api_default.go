...
func (r ApiUseTokenPostRequest) Execute() (*UseTokenPost200Response, *http.Response, error) {
...
*/
func (a *DefaultApiService) UseTokenPost(ctx context.Context) ApiUseTokenPostRequest {
	return ApiUseTokenPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultApiService) UseTokenPostExecute(r ApiUseTokenPostRequest) (*UseTokenPost200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UseTokenPost")
	if err != nil {
