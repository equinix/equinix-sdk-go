...
// The scope of the access token to be issued. Scope must be an access policy ERN or a string of the form roleassignments:{org_id}
...
/*
UseTokenPost OAuth 2.0 Token Endpoint
