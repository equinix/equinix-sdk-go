...
// checks if the CageEscortRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CageEscortRequest{}

// CageEscortRequest struct for CageEscortRequest
type CageEscortRequest struct {
	...
	ServiceDetails       CageEscortRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _CageEscortRequest CageEscortRequest
...
func (o *CageEscortRequest) GetServiceDetails() CageEscortRequestServiceDetails {
	if o == nil {
		var ret CageEscortRequestServiceDetails
		return ret
	}
...
func (o CageEscortRequest) MarshalJSON() ([]byte, error) {
...
func (o CageEscortRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CageEscortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCageEscortRequest := _CageEscortRequest{}

	err = json.Unmarshal(data, &varCageEscortRequest)

	if err != nil {
		return err
	}

	*o = CageEscortRequest(varCageEscortRequest)
...
type NullableCageEscortRequest struct {
	value *CageEscortRequest
	isSet bool
}

func (v NullableCageEscortRequest) Get() *CageEscortRequest {
	return v.value
}

func (v *NullableCageEscortRequest) Set(val *CageEscortRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCageEscortRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCageEscortRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCageEscortRequest(val *CageEscortRequest) *NullableCageEscortRequest {
	return &NullableCageEscortRequest{value: val, isSet: true}
}

func (v NullableCageEscortRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCageEscortRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
