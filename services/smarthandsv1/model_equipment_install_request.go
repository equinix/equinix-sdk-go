...
// checks if the EquipmentInstallRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EquipmentInstallRequest{}

// EquipmentInstallRequest struct for EquipmentInstallRequest
type EquipmentInstallRequest struct {
	...
	ServiceDetails       EquipmentInstallRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _EquipmentInstallRequest EquipmentInstallRequest
...
func (o *EquipmentInstallRequest) GetServiceDetails() EquipmentInstallRequestServiceDetails {
	if o == nil {
		var ret EquipmentInstallRequestServiceDetails
		return ret
	}
...
func (o EquipmentInstallRequest) MarshalJSON() ([]byte, error) {
...
func (o EquipmentInstallRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EquipmentInstallRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEquipmentInstallRequest := _EquipmentInstallRequest{}

	err = json.Unmarshal(data, &varEquipmentInstallRequest)

	if err != nil {
		return err
	}

	*o = EquipmentInstallRequest(varEquipmentInstallRequest)
...
type NullableEquipmentInstallRequest struct {
	value *EquipmentInstallRequest
	isSet bool
}

func (v NullableEquipmentInstallRequest) Get() *EquipmentInstallRequest {
	return v.value
}

func (v *NullableEquipmentInstallRequest) Set(val *EquipmentInstallRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentInstallRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentInstallRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentInstallRequest(val *EquipmentInstallRequest) *NullableEquipmentInstallRequest {
	return &NullableEquipmentInstallRequest{value: val, isSet: true}
}

func (v NullableEquipmentInstallRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentInstallRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
