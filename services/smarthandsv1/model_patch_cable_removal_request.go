...
// checks if the PatchCableRemovalRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchCableRemovalRequest{}

// PatchCableRemovalRequest struct for PatchCableRemovalRequest
type PatchCableRemovalRequest struct {
	...
	ServiceDetails       PatchCableRemovalRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _PatchCableRemovalRequest PatchCableRemovalRequest
...
func (o *PatchCableRemovalRequest) GetServiceDetails() PatchCableRemovalRequestServiceDetails {
	if o == nil {
		var ret PatchCableRemovalRequestServiceDetails
		return ret
	}
...
func (o PatchCableRemovalRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchCableRemovalRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchCableRemovalRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchCableRemovalRequest := _PatchCableRemovalRequest{}

	err = json.Unmarshal(data, &varPatchCableRemovalRequest)

	if err != nil {
		return err
	}

	*o = PatchCableRemovalRequest(varPatchCableRemovalRequest)
...
type NullablePatchCableRemovalRequest struct {
	value *PatchCableRemovalRequest
	isSet bool
}

func (v NullablePatchCableRemovalRequest) Get() *PatchCableRemovalRequest {
	return v.value
}

func (v *NullablePatchCableRemovalRequest) Set(val *PatchCableRemovalRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchCableRemovalRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchCableRemovalRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchCableRemovalRequest(val *PatchCableRemovalRequest) *NullablePatchCableRemovalRequest {
	return &NullablePatchCableRemovalRequest{value: val, isSet: true}
}

func (v NullablePatchCableRemovalRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchCableRemovalRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
