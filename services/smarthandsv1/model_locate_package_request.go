...
// checks if the LocatePackageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocatePackageRequest{}

// LocatePackageRequest struct for LocatePackageRequest
type LocatePackageRequest struct {
	...
	ServiceDetails       LocatePackageRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _LocatePackageRequest LocatePackageRequest
...
func (o *LocatePackageRequest) GetServiceDetails() LocatePackageRequestServiceDetails {
	if o == nil {
		var ret LocatePackageRequestServiceDetails
		return ret
	}
...
func (o LocatePackageRequest) MarshalJSON() ([]byte, error) {
...
func (o LocatePackageRequest) ToMap() (map[string]interface{}, error) {
...
func (o *LocatePackageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varLocatePackageRequest := _LocatePackageRequest{}

	err = json.Unmarshal(data, &varLocatePackageRequest)

	if err != nil {
		return err
	}

	*o = LocatePackageRequest(varLocatePackageRequest)
...
type NullableLocatePackageRequest struct {
	value *LocatePackageRequest
	isSet bool
}

func (v NullableLocatePackageRequest) Get() *LocatePackageRequest {
	return v.value
}

func (v *NullableLocatePackageRequest) Set(val *LocatePackageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableLocatePackageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableLocatePackageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocatePackageRequest(val *LocatePackageRequest) *NullableLocatePackageRequest {
	return &NullableLocatePackageRequest{value: val, isSet: true}
}

func (v NullableLocatePackageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocatePackageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
