...
// checks if the RunJumperCableRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunJumperCableRequest{}

// RunJumperCableRequest struct for RunJumperCableRequest
type RunJumperCableRequest struct {
	...
	ServiceDetails       RunJumperCableRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _RunJumperCableRequest RunJumperCableRequest
...
func (o *RunJumperCableRequest) GetServiceDetails() RunJumperCableRequestServiceDetails {
	if o == nil {
		var ret RunJumperCableRequestServiceDetails
		return ret
	}
...
func (o RunJumperCableRequest) MarshalJSON() ([]byte, error) {
...
func (o RunJumperCableRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RunJumperCableRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRunJumperCableRequest := _RunJumperCableRequest{}

	err = json.Unmarshal(data, &varRunJumperCableRequest)

	if err != nil {
		return err
	}

	*o = RunJumperCableRequest(varRunJumperCableRequest)
...
type NullableRunJumperCableRequest struct {
	value *RunJumperCableRequest
	isSet bool
}

func (v NullableRunJumperCableRequest) Get() *RunJumperCableRequest {
	return v.value
}

func (v *NullableRunJumperCableRequest) Set(val *RunJumperCableRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRunJumperCableRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRunJumperCableRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRunJumperCableRequest(val *RunJumperCableRequest) *NullableRunJumperCableRequest {
	return &NullableRunJumperCableRequest{value: val, isSet: true}
}

func (v NullableRunJumperCableRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRunJumperCableRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
