...
// checks if the MoveJumperCableRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoveJumperCableRequest{}

// MoveJumperCableRequest struct for MoveJumperCableRequest
type MoveJumperCableRequest struct {
	...
	ServiceDetails       MoveJumperCableRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _MoveJumperCableRequest MoveJumperCableRequest
...
func (o *MoveJumperCableRequest) GetServiceDetails() MoveJumperCableRequestServiceDetails {
	if o == nil {
		var ret MoveJumperCableRequestServiceDetails
		return ret
	}
...
func (o MoveJumperCableRequest) MarshalJSON() ([]byte, error) {
...
func (o MoveJumperCableRequest) ToMap() (map[string]interface{}, error) {
...
func (o *MoveJumperCableRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varMoveJumperCableRequest := _MoveJumperCableRequest{}

	err = json.Unmarshal(data, &varMoveJumperCableRequest)

	if err != nil {
		return err
	}

	*o = MoveJumperCableRequest(varMoveJumperCableRequest)
...
type NullableMoveJumperCableRequest struct {
	value *MoveJumperCableRequest
	isSet bool
}

func (v NullableMoveJumperCableRequest) Get() *MoveJumperCableRequest {
	return v.value
}

func (v *NullableMoveJumperCableRequest) Set(val *MoveJumperCableRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveJumperCableRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveJumperCableRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveJumperCableRequest(val *MoveJumperCableRequest) *NullableMoveJumperCableRequest {
	return &NullableMoveJumperCableRequest{value: val, isSet: true}
}

func (v NullableMoveJumperCableRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveJumperCableRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
