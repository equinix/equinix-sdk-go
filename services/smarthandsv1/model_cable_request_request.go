...
// checks if the CableRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CableRequestRequest{}

// CableRequestRequest struct for CableRequestRequest
type CableRequestRequest struct {
	...
	ServiceDetails       CableRequestRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _CableRequestRequest CableRequestRequest
...
func (o *CableRequestRequest) GetServiceDetails() CableRequestRequestServiceDetails {
	if o == nil {
		var ret CableRequestRequestServiceDetails
		return ret
	}
...
func (o CableRequestRequest) MarshalJSON() ([]byte, error) {
...
func (o CableRequestRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CableRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCableRequestRequest := _CableRequestRequest{}

	err = json.Unmarshal(data, &varCableRequestRequest)

	if err != nil {
		return err
	}

	*o = CableRequestRequest(varCableRequestRequest)
...
type NullableCableRequestRequest struct {
	value *CableRequestRequest
	isSet bool
}

func (v NullableCableRequestRequest) Get() *CableRequestRequest {
	return v.value
}

func (v *NullableCableRequestRequest) Set(val *CableRequestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCableRequestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCableRequestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCableRequestRequest(val *CableRequestRequest) *NullableCableRequestRequest {
	return &NullableCableRequestRequest{value: val, isSet: true}
}

func (v NullableCableRequestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCableRequestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
