...
// checks if the OtherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OtherRequest{}

// OtherRequest struct for OtherRequest
type OtherRequest struct {
	...
	ServiceDetails       OtherRequestServiceDetails `json:"serviceDetails"`
	AdditionalProperties map[string]interface{}
}

type _OtherRequest OtherRequest
...
func (o *OtherRequest) GetServiceDetails() OtherRequestServiceDetails {
	if o == nil {
		var ret OtherRequestServiceDetails
		return ret
	}
...
func (o OtherRequest) MarshalJSON() ([]byte, error) {
...
func (o OtherRequest) ToMap() (map[string]interface{}, error) {
...
func (o *OtherRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varOtherRequest := _OtherRequest{}

	err = json.Unmarshal(data, &varOtherRequest)

	if err != nil {
		return err
	}

	*o = OtherRequest(varOtherRequest)
...
type NullableOtherRequest struct {
	value *OtherRequest
	isSet bool
}

func (v NullableOtherRequest) Get() *OtherRequest {
	return v.value
}

func (v *NullableOtherRequest) Set(val *OtherRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableOtherRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableOtherRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOtherRequest(val *OtherRequest) *NullableOtherRequest {
	return &NullableOtherRequest{value: val, isSet: true}
}

func (v NullableOtherRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOtherRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
