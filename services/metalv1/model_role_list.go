...
type RoleList struct {
	Roles                []RoleListRolesInner `json:"roles,omitempty"`
...
// SetRoles gets a reference to the given []RoleListRolesInner and assigns it to the Roles field.
