...
// checks if the DeviceMetro type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceMetro{}
...
func (v NullableDeviceMetro) Get() *DeviceMetro {
	return v.value
}
...
func NewNullableDeviceMetro(val *DeviceMetro) *NullableDeviceMetro {
	return &NullableDeviceMetro{value: val, isSet: true}
}
