...
*/
func (a *MetalGatewaysApiService) CreateBgpDynamicNeighbor(ctx context.Context, id string) ApiCreateBgpDynamicNeighborRequest {
	return ApiCreateBgpDynamicNeighborRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *MetalGatewaysApiService) CreateBgpDynamicNeighborExecute(r ApiCreateBgpDynamicNeighborRequest) (*BgpDynamicNeighbor, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetalGatewaysApiService.CreateBgpDynamicNeighbor")
	if err != nil {
...
*/
func (a *MetalGatewaysApiService) GetBgpDynamicNeighbors(ctx context.Context, id string) ApiGetBgpDynamicNeighborsRequest {
	return ApiGetBgpDynamicNeighborsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *MetalGatewaysApiService) GetBgpDynamicNeighborsExecute(r ApiGetBgpDynamicNeighborsRequest) (*BgpDynamicNeighborList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetalGatewaysApiService.GetBgpDynamicNeighbors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
