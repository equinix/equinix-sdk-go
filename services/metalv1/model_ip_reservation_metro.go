...
// checks if the IPReservationMetro type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPReservationMetro{}
...
type NullableIPReservationMetro struct {
	value *IPReservationMetro
	isSet bool
}

func (v NullableIPReservationMetro) Get() *IPReservationMetro {
	return v.value
}

func (v *NullableIPReservationMetro) Set(val *IPReservationMetro) {
	v.value = val
	v.isSet = true
}
...
func NewNullableIPReservationMetro(val *IPReservationMetro) *NullableIPReservationMetro {
	return &NullableIPReservationMetro{value: val, isSet: true}
}
