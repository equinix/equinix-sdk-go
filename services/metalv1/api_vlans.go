...
func (r ApiDeleteVirtualNetworkRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *VLANsApiService) DeleteVirtualNetworkExecute(r ApiDeleteVirtualNetworkRequest) (*http.Response, error) {
	var (
...
type ApiUpdateVirtualNetworkRequest struct {
	ctx                       context.Context
	ApiService                *VLANsApiService
	id                        string
	virtualNetworkUpdateInput *VirtualNetworkUpdateInput
	include                   *[]string
	exclude                   *[]string
}

// Virtual network to update
func (r ApiUpdateVirtualNetworkRequest) VirtualNetworkUpdateInput(virtualNetworkUpdateInput VirtualNetworkUpdateInput) ApiUpdateVirtualNetworkRequest {
	r.virtualNetworkUpdateInput = &virtualNetworkUpdateInput
	return r
}

// Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.
func (r ApiUpdateVirtualNetworkRequest) Include(include []string) ApiUpdateVirtualNetworkRequest {
	r.include = &include
	return r
}

// Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.
func (r ApiUpdateVirtualNetworkRequest) Exclude(exclude []string) ApiUpdateVirtualNetworkRequest {
	r.exclude = &exclude
	return r
}

func (r ApiUpdateVirtualNetworkRequest) Execute() (*VirtualNetwork, *http.Response, error) {
	return r.ApiService.UpdateVirtualNetworkExecute(r)
}

/*
UpdateVirtualNetwork Updates the virtual network

Updates the virtual network.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Virtual Network UUID
	@return ApiUpdateVirtualNetworkRequest
*/
func (a *VLANsApiService) UpdateVirtualNetwork(ctx context.Context, id string) ApiUpdateVirtualNetworkRequest {
	return ApiUpdateVirtualNetworkRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return VirtualNetwork
func (a *VLANsApiService) UpdateVirtualNetworkExecute(r ApiUpdateVirtualNetworkRequest) (*VirtualNetwork, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VLANsApiService.UpdateVirtualNetwork")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.virtualNetworkUpdateInput == nil {
		return localVarReturnValue, nil, reportError("virtualNetworkUpdateInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.virtualNetworkUpdateInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["x_auth_token"]; ok {
